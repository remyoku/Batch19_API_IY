...
public class C04_GetRequestWithPathMethod_SimpleBody {
    ...
    public void simpleBodyWithPathMethod() {
        ...
        //isbn numarasını response body den alalım

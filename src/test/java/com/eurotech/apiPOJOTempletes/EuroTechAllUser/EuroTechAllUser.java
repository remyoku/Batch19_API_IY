...
package com.eurotech.apiPOJOTempletes.EuroTechAllUser;
...
public class EuroTechAllUser {
    ...
    public String toString() {
        ...
        sb.append(EuroTechAllUser.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
